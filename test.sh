...
check_cbc	1		"| foo | foo := 'foobarbaz', foo = 'foobarbaz'"
check_cbc	0		"| foo | foo := 'foobarbaz', foo = 'foobar'"
check_cbc	0		"| foo | foo := 'foobarbaz', foo <> 'foobarbaz'"
check_cbc	1		"| foo | foo := 'foobarbaz', foo <> 'foobar'"
