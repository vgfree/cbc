...
check_cbc	1		"declare foo, foo := 0, if foo = 1 then 5, else 1, endif"
check_cbc	5		"declare foo, foo := 1, if foo = 1 then 5, else 1, endif"
check_cbc	5		"declare foo, foo := 0, if foo <> 1 then 5, else 1, endif"
check_cbc	1		"declare foo, foo := 1, if foo <> 1 then 5, else 1, endif"
check_cbc	5		"declare foo, foo := 6, if foo > 5 then 5, else 1, endif"
check_cbc	1		"declare foo, foo := 1, if foo > 5 then 5, else 1, endif"
check_cbc	1		"declare foo, foo := 6, if foo < 5 then 5, else 1, endif"
check_cbc	5		"declare foo, foo := 1, if foo < 5 then 5, else 1, endif"
check_cbc	5		"declare foo, foo := 5, if foo >= 5 then 5, else 1, endif"
check_cbc	1		"declare foo, foo := 1, if foo >= 5 then 5, else 1, endif"
check_cbc	5		"declare foo, foo := 5, if foo <= 5 then 5, else 1, endif"
check_cbc	5		"declare foo, foo := 1, if foo <= 5 then 5, else 1, endif"
