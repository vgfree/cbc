...
check_cbc_text		"True"		"| foo, bar, baz | foo := 1, bar := 2, if foo < bar then baz := True, else baz := False, endif, baz,"
check_cbc_text		"True"		"| foo | foo := 'foobarbaz', foo = 'foobarbaz',"
check_cbc_text		"False"		"| foo | foo := 'foobarbaz', foo = 'foobar',"
check_cbc_text		"False"		"| foo | foo := 'foobarbaz', foo <> 'foobarbaz',"
check_cbc_text		"True"		"| foo | foo := 'foobarbaz', foo <> 'foobar',"
check_cbc_text		"string1"	"| foo, bar, baz | foo := 1, bar := 2, if foo < bar then baz := 'string1', else baz := 'string2', endif, baz,"
